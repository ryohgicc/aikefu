...
### v2.3.1 (最新版本)
- 🐛 **体验优化**: 修复设置弹窗内容过多时无法滚动的问题

### v2.3.0
- 🆕 **自定义快捷按钮**: 在设置中可自定义4个快捷按钮的标题和内容，点击后自动填充到网页输入框

### v2.2.1
- 🧹 **功能精简**: 移除"智能回复建议"模块，简化侧边栏界面，专注于回答优化和翻译功能

### v2.2.0
- 🆕 **用户问题自动翻译**: 自动识别并翻译网页提取或手动输入的用户问题，在侧边栏即时显示中文翻译，辅助理解
